...
```{r}
# k number of succesestsof us getting a G allele
# p is the proportion of G alleles in the prior so 0.20
# n is the sampling total
# Sampling
k=40
n=200
...
shape1=k+alpha
shape2=n-k+beta
prob=dbeta(x, shape1, shape2, nc= 0)

plot(x,prob, main = "200 samples allele freq of 0.20")
# 10 samples allele freq if 0,20
k=2
n=10

x=seq(0,1,length=1000)
shape1=k+alpha # K is the b allele
shape2=n-k+beta # n-k is the A lelle? 
prob=dbeta(x, shape1, shape2, nc= 0)

plot(x,prob, main = "10 samples allele freq 0.20")
